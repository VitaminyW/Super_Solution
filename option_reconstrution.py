...
parser.add_argument('--seed', type=int, default=1,
                    help='random seed')
parser.add_argument('--data_dir', type=str, default='/home/yewei/liif_Data',
                    help='dataset directory')
parser.add_argument('--data_train', type=str, default='my_reconstruction',
                    help='train dataset name')
parser.add_argument('--data_test', type=str, default='my_val',
...
parser.add_argument('--pre_train', type=str, default='/home/yewei/DRN_code/experiment/test_finetune/model/model_best.pt',
                    help='pre-trained model directory')
parser.add_argument('--pre_train_dual', type=str, default='/home/yewei/DRN_code/experiment/test_finetune/model/dual_model_best.pt',
...
parser.add_argument('--save', type=str, default='./experiment/test_finetune/',

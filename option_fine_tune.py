...
parser.add_argument('--data_train', type=str, default='my_fine_tune',
...
parser.add_argument('--pre_train', type=str, default='/home/yewei/DRN_code/experiment/test/model/model_best.pt',
                    help='pre-trained model directory')
parser.add_argument('--pre_train_dual', type=str, default='/home/yewei/DRN_code/experiment/test/model/dual_model_best.pt',
